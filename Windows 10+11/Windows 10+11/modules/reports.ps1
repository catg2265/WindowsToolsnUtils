...
function Test-FilePath{
    ...
    if (Test-Path $filePath) {
        ...
        $oldPath = Join-Path $directory "$name`OLD$ext"
    
        Rename-Item -Path $filePath -NewName (Split-Path $oldPath -Leaf)
    }
}
...
"@
    ...
    Test-FilePath -filePath $specSheetPath
...
€$estimatedPrice
"@
    Test-FilePath -filePath $internalFilePath
